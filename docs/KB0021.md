# KB0021 - How to replace host share credentials Password:
 ...
 The following steps provide a way to replace a host share credential using API trhough rbkcli.
...
3. Change the share credentials (rbkcli host share_credential -m post -p hostId=<host_id>,username=<user>,password=<pass>):
	...
	```
	$ rbkcli host share_credential -m post -p hostId=Host:::88560c47-6c60-4140-acdd-2c7439715191,username=root,password=VMware1!
	{
	  "username": "root",
	  "hostId": "Host:::88560c47-6c60-4140-acdd-2c7439715191"
	}
