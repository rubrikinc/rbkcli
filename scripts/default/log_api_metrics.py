...
class LogApiMetric(RbkCliBlackOps):
    ...
    def execute(self, args):
        """Method that calls operation from rbkcli."""
        ...
        args = self._assing_defined_param(args)
        ...
        result = []
        log_location = ''
        log_folders = self.get_folder_path(log_location)
    ...
    def _assing_defined_param(self, args):
        ...
        for param in self.parameters:
            ...
            try:
                ...
                if param['required']:
                    raise Exception('The parameter %s is required.' % name)
    ...
    def get_folder_path(self, log_location):
    ...
    def get_log_files(self, node, log_folders):
    ...
    def extract_userline(self, important_line, metric):
    ...
    def get_relevant_lines(self, metric, current_log):
    ...
    def parse_log_line(self, str_line):
    ...
    def sort_threads(self, threads, logs):
